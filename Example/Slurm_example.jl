...
##
@time System =  getSquareLattice(NLen,[1.,J2])

Par = Params(System,OneLoop(),T=T,MinimalOutput = false, N=64,Ngamma = 64,accuracy = 1E-8 ,Lam_max = exp(10.),Lam_min = exp(-10.))
mainFile = "../Data/J1J2Tsweep/"*PMFRG.generateFileName(Par,"_T=_$(strd(T))_J2=_$(strd(J2))")
...
Solution,saved_values = SolveFRG(Par,MainFile = mainFile ,CheckpointDirectory = flowpath,method = DP5(),VertexCheckpoints = [],CheckPointSteps = 10;Group)
