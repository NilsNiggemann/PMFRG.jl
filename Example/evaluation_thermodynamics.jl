...
let 
    fig = Figure()
    ax_e = Axis(fig[1,1],ylabel = L"E/N",xlabelvisible = false, xticklabelsvisible = false)
    ax_s = Axis(fig[2,1],ylabel = L"S/N",xlabelvisible = false, xticklabelsvisible = false)
