function test_saving(
    ...
    saved_values = DiffEqCallBacks.SavedValues(Float64, PMFRGCore.Observables)

    obs1 = PMFRGCore.getObservables(PMFRGCore.Observables, State, Par.NumericalParams.Lam_max, Par)
