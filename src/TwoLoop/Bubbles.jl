...
function addBL!(B::BubbleType,XL::BubbleType,XR::BubbleType,Γ::VertexType,is::Integer, it::Integer, iu::Integer, nwpr::Integer,Par::PMFRGParams,Props,VBuffer::VertexBufferType,XBuffer::BubbleBufferType,BufferFiller!::Func1 = fillBufferL!,SiteIndex::Func2 = identity) where {Func1 <: Function ,Func2 <: Function }
    ...
    @inbounds for Rij in 1:Npairs
        ...
        @turbo unroll = 1 for k_spl in 1:Nsum[Rij]
            ...
            ki,kj,m,xk = S_ki[k_spl,Site],S_kj[k_spl,Site],S_m[k_spl,Site],S_xk[k_spl,Site]
...
@inline function addBR!(B::BubbleType,XL::BubbleType,XR::BubbleType,Γ::VertexType,is::Integer, it::Integer, iu::Integer, nwpr::Integer,Par::PMFRGParams,Props,VBuffer::VertexBufferType,XBuffer::BubbleBufferType) 
    addBL!(B::BubbleType,XL::BubbleType,XR::BubbleType,Γ::VertexType,is::Integer, it::Integer, iu::Integer, nwpr::Integer,Par::PMFRGParams,Props,VBuffer::VertexBufferType,XBuffer::BubbleBufferType,fillBufferR!,x->Par.System.invpairs[x])
end

@inline function addBRTilde!(B::BubbleType,XL::BubbleType,XR::BubbleType,Γ::VertexType, is::Integer, it::Integer, iu::Integer, nwpr::Integer, Par::PMFRGParams,Props)
    addBLTilde!(B::BubbleType,XL::BubbleType,XR::BubbleType,Γ::VertexType, is::Integer, it::Integer, iu::Integer, nwpr::Integer, Par::PMFRGParams,Props,freqs->(freqs[3],freqs[4],freqs[1],freqs[2]))
end
##
