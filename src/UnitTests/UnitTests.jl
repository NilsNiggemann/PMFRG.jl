...
BechmarkingParams(Method::Parquet) = Params(getPolymer(2),Method,N=24,Ngamma = 24,T=0.8,accuracy = 1e-3,usesymmetry = false,Lam_min = 0.,MinimalOutput = true,lenIntw = 120)
